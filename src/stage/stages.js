...
export const STAGES = [
...

  {
    ...
    wave: {
      ...
      goal: 16,
      steps: [
        { untilKills: 6, maxAlive: 5, interval: 1.2, mix: { sirenWarrior: 1 } },
        { untilKills: 16, maxAlive: 8, interval: 0.9, mix: { sirenWarrior: 3, sirenArcher: 2 }, say: '물에서 올라온다' },
      ],
...

  {
    ...
    wave: {
      ...
      goal: 14,
      steps: [
        { untilKills: 6, maxAlive: 6, interval: 1.0, mix: { messinaWarrior: 3, messinaArcher: 1 } },
        { untilKills: 14, maxAlive: 8, interval: 0.8, mix: { messinaWarrior: 3, messinaArcher: 2 }, say: '파도가 갑판을 넘는다' },
      ],
...

  {
    ...
    wave: {
      ...
      goal: 30,
      steps: [
        { untilKills: 8, maxAlive: 6, interval: 0.9, mix: { suitorWarrior: 1 } },
        { untilKills: 18, maxAlive: 11, interval: 0.65, mix: { suitorWarrior: 4, suitorArcher: 2, shield: 1 }, say: '위층에서도 내려온다' },
        { untilKills: 30, maxAlive: 15, interval: 0.5, mix: { suitorWarrior: 4, suitorArcher: 2, shield: 2 }, say: '문이란 문에서 쏟아진다' },
      ],
      clear: '한 사람만 남았다.',
    },
