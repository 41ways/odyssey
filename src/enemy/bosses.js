  ...
  phases: [
    {
      ...
      patterns: [
        ...
        volley({ id: 'sheep', startup: 1.0, active: 0.1, recovery: 0.8, count: 1, spread: 0,
    ...
    },
    {
      ...
      patterns: [
        volley({ id: 'sheep_wild', startup: 0.62, active: 0.1, recovery: 0.5, count: 3, spread: 0.75,
  ...
  phases: [
    ...
    },
    {
      ...
      patterns: [
        ...
        volley({ id: 'rain', startup: 0.9, active: 0.1, recovery: 0.8, count: 5, spread: 0.55,
  ...
  phases: [
    {
      ...
      patterns: [
        ...
        volley({ id: 'fireball', startup: 0.75, active: 0.08, recovery: 0.6, count: 3, spread: 0.32,
    ...
    },
    {
      ...
      say: '웃음이 그쳤다',
      patterns: [
        spray({ id: 'circle', startup: 0.8, active: 0.08, recovery: 0.7, count: 16, damage: 14,
          speed: 7.5, bullet: '#ff7a3a', warn: 3, pick: { weight: 4, cooldown: 4 } }),
        volley({ id: 'fireball2', startup: 0.52, active: 0.08, recovery: 0.45, count: 5, spread: 0.5,
  ...
  phases: [
    {
      ...
      patterns: [
        spray({ id: 'song', startup: 0.9, active: 0.08, recovery: 0.7, count: 14, damage: 13,
    ...
    },
    {
      ...
      say: '노래가 비명으로 바뀐다',
      patterns: [
        spray({ id: 'song2', startup: 0.62, active: 0.08, recovery: 0.55, count: 20, damage: 14,
  ...
  phases: [
    {
      ...
      say: '바다가 통째로 빨려 들어간다',
      patterns: [
        spray({ id: 'gyre', startup: 0.8, active: 0.08, recovery: 0.6, count: 18, damage: 14,
        ...
        volley({ id: 'spout', startup: 0.7, active: 0.08, recovery: 0.5, count: 7, spread: 0.75,
    ...
    },
    {
      ...
      say: '소용돌이가 빨라진다',
      patterns: [
        spray({ id: 'gyre2', startup: 0.55, active: 0.08, recovery: 0.45, count: 26, damage: 15,
        ...
        volley({ id: 'spout2', startup: 0.5, active: 0.08, recovery: 0.4, count: 11, spread: 1.0,
  ...
  phases: [
    {
      ...
      patterns: [
        ...
        volley({ id: 't_bow', startup: 0.5, active: 0.08, recovery: 0.4, count: 1, spread: 0,
